...
{
    public const CONFIG_KEY_VERSION = "site.plugins.bitbucket.version";
    public const CONFIG_KEY_TOKEN = "site.plugins.bitbucket.token";
    public const CONFIG_KEY_DEFAULT_USER = "site.plugins.bitbucket.default_user_id";
